...
/**
 * The base class for all interaction structures.
...
export class BaseInteraction extends Base {
	 ...
	 * @param data - The {@link APIInteraction | `APIInteraction`} object.
	 ...
	 * JSON object.
	 * @returns The {@link JSONBaseInteraction | `JSONBaseInteraction`}
	 * object.
	 */
