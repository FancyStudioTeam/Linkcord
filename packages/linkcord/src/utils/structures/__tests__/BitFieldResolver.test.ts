...
describe("Class: BitFieldResolver", () => {
  ...
  it("Adds the given bit to the bitfield and returns the updated value.", () => {
  ...
  it("Checks if the given bit is set in the bitfield and returns a boolean depending on the result.", () => {
